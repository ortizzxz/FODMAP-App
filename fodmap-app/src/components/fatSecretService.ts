...
// search image stock 
const relevantTags = new Set(['slice','plant','olives', 'green', 'oil', 'vegetables', 'vegetable', 'condiment', 'kitchen', 'flower', 'cocoa beans', 'cocoa', 'cooking', 'cook', 'food', 'raw', 'nutrition', 'foodstuff', 'agriculture', 'plants', 'fruit', 'cultivation', 'beans']);
